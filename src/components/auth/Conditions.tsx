  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 sm:p-6 relative overflow-hidden particle-bg">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-blue-500 to-indigo-700 rounded-full opacity-30 filter blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      </div>

      <div className="relative w-full max-w-4xl bg-black/50 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl p-8 sm:p-12 text-white/90 overflow-y-auto max-h-[90vh] font-sans leading-relaxed">
        {onBack && (
          <div className="absolute top-6 left-6 z-10">
            <button
              onClick={onBack}
              aria-label="Go back"
              className="flex items-center justify-center w-12 h-12 rounded-full bg-white/10 hover:bg-white/20 focus:ring-4 focus:ring-blue-500/50 focus:outline-none text-white font-semibold transition duration-300 shadow-md"
            >
        ...
        <h1 className="text-4xl sm:text-5xl font-black mb-10 text-center bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 bg-clip-text text-transparent drop-shadow-lg">
          Terms and Conditions
        </h1>

        <p className="mb-8 text-center text-lg font-semibold text-white/70">
        ...
        {[
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <address className="not-italic mb-8 text-lg text-blue-400 font-medium">
          ...
          <section key={id} aria-labelledby={`section-${id}`} className="mb-8">
            <h2
              id={`section-${id}`}
              className="text-3xl font-bold mb-4 border-b-2 border-blue-500 pb-2 text-white"
            >
              {id}. {title}
            </h2>
            {content}
        ...
        <section aria-labelledby="warning-copying" className="mb-12">
          <p
            id="warning-copying"
            className="mb-8 text-sm text-red-400 font-semibold text-center select-none p-4 bg-red-500/10 border border-red-500/30 rounded-lg"
          >
        ...
        <footer className="mt-12 pt-8 border-t border-white/20 text-sm text-white/70">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            ...
            <div className="flex space-x-6">
              <a href="#" aria-label="Twitter" className="hover:text-white transition-colors"><TwitterLogo /></a>
              <a href="#" aria-label="LinkedIn" className="hover:text-white transition-colors"><LinkedinLogo /></a>
              <a href="#" aria-label="GitHub" className="hover:text-white transition-colors"><GitHubLogo /></a>
            </div>
          </div>
        </footer>
      </div>
