...
import { aiCoachService, GoalRecommendation, GoalAdjustment, MotivationalTip } from './aiCoachService';
  ...
  const initializeProgressTracker = async () => {
    try {
      ...
      const [aiRecommendations, aiAdjustment, aiTip] = await Promise.all([
        aiCoachService.getPersonalizedRecommendations(userGoals, calculatedStats),
        aiCoachService.getSmartAdjustments(userGoals),
        aiCoachService.getMotivationalTip(calculatedStats),
      ]);
          ...
          <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center sm:text-left">
            ...
            <div>
              ...
              <div className="flex justify-center sm:justify-start space-x-4">
                <a href="#" aria-label="Twitter" className="hover:text-white transition-colors duration-200"><TwitterLogo /></a>
                <a href="#" aria-label="Facebook" className="hover:text-white transition-colors duration-200"><FacebookLogo /></a>
                <a href="#" aria-label="GitHub" className="hover:text-white transition-colors duration-200"><GitHubLogo /></a>
              </div>
            </div>
          </div>
