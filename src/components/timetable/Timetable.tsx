        ...
        <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center sm:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              <a href="https://x.com/gyantappas" aria-label="Twitter" className="hover:text-white transition-colors duration-200"><TwitterLogo /></a>
              <a href="https://www.facebook.com/profile.php?id=61579774640959" aria-label="Facebook" className="hover:text-white transition-colors duration-200"><FacebookLogo /></a>
              <a href="https://github.com/vsavgyantappas" aria-label="GitHub" className="hover:text-white transition-colors duration-200"><GitHubLogo /></a>
            </div>
          </div>
        </div>
