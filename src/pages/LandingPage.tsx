...
import { BarChart, BookOpen, Calendar, CheckCircle2, Clock, Cpu, Github, Linkedin, MessageSquare, Shield, Star, Target, TrendingUp, Twitter, Users, Zap } from 'lucide-react';
  ...
  <SectionWrapper id="about" className="bg-black/20">
    <div className="container mx-auto text-center max-w-4xl">
      ...
      <div className="text-lg md:text-xl text-gray-300 space-y-6">
        ...
        <div className="pt-6">
          <Link to="/about">
             <button className="px-8 py-3 bg-white/10 hover:bg-white/20 text-white rounded-full transition-all border border-white/20">
                Read Our Full Story
             </button>
          </Link>
        </div>
    ...
    <SectionWrapper id="contact">
      <div className="container mx-auto max-w-2xl">
        ...
        >
          ...
          <motion.div variants={cardVariants} className="text-center flex flex-col gap-4">
            <button type="submit" className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-emerald-500 to-blue-600 hover:shadow-lg hover:shadow-emerald-500/40 text-white font-bold py-4 px-10 rounded-xl transition-all duration-300 transform hover:scale-105">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left mb-8">
        <div>
          <div className="flex items-center gap-3 mb-4 justify-center md:justify-start">
            ...
            <p className="font-bold text-xl text-white">MARGDARSHAK</p>
          </div>
