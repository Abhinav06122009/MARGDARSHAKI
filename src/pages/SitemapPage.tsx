...
import { ArrowLeft, Map, FileText, Lock, Layout, BookOpen, Calculator as CalcIcon } from 'lucide-react';
  ...
  const links = [
    ...
    },
    {
      ...
      items: [
        ...
        // Add future tools here (e.g., GPA Calculator)
      ]
    },
    {
      ...
      items: [
        ...
        { name: "Study Techniques Guide", path: "/blog/study-techniques-2025" },
        { name: "Exam Stress Management", path: "/blog/manage-exam-stress" },
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">Complete overview of MARGDARSHAK</p>
          </div>
                ...
                <ul className="space-y-3">
                  {section.items.map((link, i) => (
                    <li key={i}>
                      <Link 
                        to={link.path} 
                        className="text-gray-400 hover:text-white hover:underline transition-all flex items-center gap-2 group"
                      >
